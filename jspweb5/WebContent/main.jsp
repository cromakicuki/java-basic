...
<%@ include file="menu.jsp" %>
	...
	mt-5 :		박스가 브라우저 상단에 붙지 않도록 최대 마진을 설정한다. 0-5
	p-5 :		박스 안쪽 여백을 설정
	w-75 : 		박스의 크기를 브라우저 크기의 75%로 유지 -->
		...
		<table align=center>
			<tr height=40>
				...
				<td align=right><a href='feed.jsp'><button type="button" class="btn btn-outline-primary">글쓰기</button></a>
				</td>
			</tr>
			<%
			...
			<tr>
				<td><small>작성자:<%=name%></small></td>
				<td><small>작성시간: <%=ts%></small></td>
			</tr>
			<tr>
