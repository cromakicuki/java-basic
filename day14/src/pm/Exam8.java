...
public class Exam8 {
	...
	public static void main(String[] args) {
		...
		//Set 컬렉션
		/*
		 동일한 타입의 묶음이라는 특징은 그대로 갖고 잇지만 인덱스 정보를 포함하지 않는
		 즉 집합의 개념과도 같은 컬렉션이다. 인덱스가 없으므로 데이터를 중복해서 저장하면
		...
		/*
		 ...
		 여기서 생각해볼 것은 '데이터가 같다' 또는 '데이터가 다르다'의 기준은 무엇일까...
		 예를 들면 3과 3은 같은 데이터이다. 즉 2개 이상을 저장할 수 없다.
		 A a1 = new A(3) 과 A a2 = new A(3) 생성자에 동일한 값을 넘겨서 객체를
		 생성했으므로 두 객체는 완벽히 똑같다. 하지만 Set의 관점에서는 다른 객체이다.
		 즉 둘 다 저장할 수 없다.똑같은 예로 String s1 = new String("hi")
